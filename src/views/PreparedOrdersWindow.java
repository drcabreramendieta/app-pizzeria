 ...
 * @author hola
 */
public class PreparedOrdersWindow extends javax.swing.JFrame {

    /**
     * Creates new form PreparedOrdersWindow
     */
    public PreparedOrdersWindow() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PreparedOrdersWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PreparedOrdersWindow().setVisible(true);
            }
        });
    }
